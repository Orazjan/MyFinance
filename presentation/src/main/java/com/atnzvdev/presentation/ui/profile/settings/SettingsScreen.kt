...
import com.atnzvdev.presentation.ui.components.ClickableRow
import com.atnzvdev.presentation.ui.components.DestructiveCard
...
import com.atnzvdev.presentation.ui.components.SectionHeader
    ...
    LaunchedEffect(Unit) {
        viewModel.events.collect { events ->
            when (events) {
                ...
                is SettingsEvent.OpenVersionInfo -> navHostController.navigate(AppDestination.VersionOfApp)
